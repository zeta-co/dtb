...
class DateExtractor(Protocol):
    ...
    def extract_date(self, filename: str) -> Optional[datetime.datetime]:
...
class RegexDateExtractor:
    ...
    def __init__(self, 
                 pattern: str, 
                 parse_func: Callable[[str], datetime.datetime],
                 description: str = ""):
...
class DateExtractors:
    ...
    def yyyy_mm_dd() -> RegexDateExtractor:
        return RegexDateExtractor(
            ...
            parse_func=lambda x: datetime.datetime.strptime(x, "%Y-%m-%d"),
    ...
    def custom_format(pattern: str, 
        ...
        return RegexDateExtractor(
            pattern=pattern,
            parse_func=lambda x: datetime.datetime.strptime(x, date_format),
