...
from .filename_date_resolver import FilenameDateResolver
...
class SchemaLoader:
    ...
    def __init__(
        self, schema_registry: SchemaRegistry, date_resolver: FilenameDateResolver
    ):
    ...
    def get_schema_for_file(self, filename: str) -> Optional[Dict[str, str]]:
        ...
        file_date = self.date_resolver.get_date(filename)
